...
![Website](assets/images/stream-vs_1.png)
![Website](assets/images/stream-vs_2.png)
![Website](assets/images/stream-vs_3.png)
![Website](assets/images/stream-vs_4.png)

It's pretty obvious that to obtain the flag, you need to beat cookiezi...  
but he's too good! so let's figure out how to cheat.
...
The game uses websockets to do networking. This line sends the player's clicks (timestamps) of the current song to the server:
```js
ws.send(JSON.stringify({ type: "results", data: { clicks: [...clicks], start, end } }));
```

Let's look at how the score is calculated:
